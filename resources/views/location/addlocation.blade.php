                ...
                <form action = '/addlocation' method = 'post'>
                    ...
                    <div class = 'mb-3'>
                        ...
                        <input type = 'text' name = 'country' id = 'country' placeholder = 'country'
                            class = "@error('country') input_err @enderror form-control" value = "{{old('country')}}"
                        />
                        @error('country')
                            <div class = "error-msg">{{$message}}</div>
                        @enderror
                    ...
                    <div class = 'mb-3'>
                        ...
                        <textarea name = 'overview' id = 'overview' placeholder = 'overview'
                            class = "@error('overview') input_err @enderror form-control" >{{old('overview')}}</textarea>
                    ...
                    <div class = 'mb-3'>
                        ...
                        <input type = 'text' name = 'cover_imageurl' id = 'cover_imageurl' placeholder = 'cover image url'
                            class = "@error('cover_imageurl') input_err @enderror form-control" value = "{{old('cover_imageurl')}}"
                        />
                    ...
                    <div class = 'mb-3'>
                        ...
                        <input type = 'number' max = '100' name = 'popularity' id = 'popularity' placeholder = 'popularity'
                            class = "@error('popularity') input_err @enderror form-control" value = "{{old('popularity')}}"
                        />
                        @error('popularity')
                            <div class = "error-msg">{{$message}}</div>
                        @enderror
