                    ...
                    <form action = '/updateevent/{{$id}}' method = 'post'>
                        ...
                        <div class="mb-3">
                            ...
                            <input type = 'text' name = 'name' id = 'name' placeholder = 'name'
                                class = "@error('name') input_err @enderror form-control" value = "{{old('name', $event->name)}}"
                            />
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type = 'text' name = 'discription' id = 'discription' placeholder = 'discription'
                                class = "@error('discription') input_err @enderror form-control">{{old('discription', $event->discription)}}</textarea>
                            @error('discription')
                                <div class="error-msg">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type = 'text' name = 'imageurl' id = 'imageurl' placeholder = 'image url'
                                class = "@error('imageurl') input_err @enderror form-control" value = "{{old('imageurl', $event->imageurl)}}"
                            />
                            @error('imageurl')
                                <div class="error-msg">{{$message}}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type = 'date' name = 'date' id = 'eventdate' placeholder = 'date'
                                class = "@error('date') input_err @enderror form-control" value = "{{old('date', $event->event_date)}}"
                            />
                            @error('date')
                                <div class="error-msg">{{$message}}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type = 'text' name = 'location' id = 'autocomplete-search' placeholder = 'location search'
                                class = "@error('location') input_err @enderror form-control" value = "{{old('location', $location)}}"
                            />
                            @error('location')
                                <div class="error-msg">{{$message}}</div>
                            @enderror
